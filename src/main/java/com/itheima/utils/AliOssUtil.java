...
public class AliOssUtil {
    ...
    private static final String ACCESS_KEY_ID = "LTAI5tEpqbkhxVVFL1iB4KmB";
    private static final String ACCESS_KEY_SECRET="qukuFcGxPHJEVp8WYTrGDUjv5Bk3nE";
    // 填写Bucket名称，例如examplebucket。
    public static final String bucketName = "1024team";
